        ...
        for (OperateData operateData : dataList) {
            try {
                FileResult fileResult =
                        fileHandleSelector.handle(operateData.getFileType().getType(), OperateType.COMPARE.getType(), operateData,
                                operateConfigDto);
                ...
                operateDetail.setErrorCode(ErrorType.COMPARE_FILES_HANDLE_ERROR.getError());
                operateDetail.setReason(ErrorType.COMPARE_FILES_HANDLE_ERROR.getMessage());
